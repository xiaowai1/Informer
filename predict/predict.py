...
parser.add_argument('--root_path', type=str, default='./preprocess_data', help='root path of the data file')
...
parser.add_argument('--rolling_data_path', type=str, default='ali20_c_test.csv', help='data file')
...
setting = 'informer_custom_ftM_sl144_ll72_pl12_dm512_nh8_el2_dl1_df2048_atprob_fc5_ebtimeF_dtTrue_mxTrue_test_0'
...
plt.yticks(np.linspace(0, 1, 11))  # 设置 x 轴的刻度为从 0 到 1 的 11 个点
plt.legend()
plt.show()
