...
def train(model, args, scaler, device):
    ...
    for i in tqdm(range(epochs)):
        ...
        torch.save(model.state_dict(), './TCN/save_model.pth')
        time.sleep(0.1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_path', type=str, default='./preprocess_data/processed_ali20_c.csv', help="你的数据数据地址")
    ...
    parser.add_argument('-save_path', type=str, default='./TCN/models')
