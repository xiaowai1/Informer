...
from data.data_loader import DatasetCustom, DatasetPred
        ...
        for target in ['avgmem', 'avgcpu']:
            ...
            if args.is_rolling_predict:
                if args.features == 'MS' or args.features == 'S':
                    ...
                    plt.plot(range(len(history_data), len(history_data) + pre_len),
                             pre_data[target][:pre_len].tolist(), label='Actual Values')
                    plt.plot(range(len(history_data), len(history_data) + pre_len), dict_of_lists[f'forecast{target}'],
                             label='Predicted Values')
            else:
                if args.features == 'MS' or args.features == 'S':
                    plt.plot(range(len(history_data)), history_data,
                    ...
                    plt.plot(range(len(history_data)), history_data,
                             label='Past Actual Values')
                    plt.plot(range(len(history_data), len(history_data) + len(dict_of_lists[f'forecast{target}'])),
